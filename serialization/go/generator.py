...
def main():
  print("--- Generating Go Test Data ---")

  # 1. Check prerequisites
  tck.check_command_installed("git")
  tck.check_command_installed("go")
  tck.check_command_installed("make")

  # 2. Define paths
  repository_dir = tck.repository_root()
  temp_dir = repository_dir / "tmp_datasketches_go"
  output_dir = repository_dir / "serialization" / "go" / "snapshots"
  ...
  # 4. Clone repository
  repo_url = "https://github.com/apache/datasketches-go.git"
  ...
  # 5. Generate files
  tck.run_command(["make", "generate-go-snapshots"], cwd=temp_dir)

  # 6. Copy generated files
  generated_files_dir = temp_dir / "serialization_test_data" / "go_generated_files"
